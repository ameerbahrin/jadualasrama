...
if (isset($_POST['update'])) {
	...
	$result = mysqli_query($con, "UPDATE jadual SET minggu='$minggu', isnin='$isnin', selasa='$selasa', rabu='$rabu', khamis='$khamis', jumaat='$jumaat', sabtu='$sabtu', ahad='$ahad' WHERE minggu='$minggu'");
	echo "<script>alert('Kemaskini maklumat berjaya'); window.location='jadual.php'</script>";
}
 ?>
 <?php 
$minggu = $_GET['minggu'];
...
<table>
		...
		<br><input type="submit" name="update" id="submit" value="Submit">
